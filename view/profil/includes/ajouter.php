<!-- 
    ---------------------------------------------------------------
     CETTE PAGE EST CHARGÉE LORSQUE LE BUTTON DU MODAL DE LA PAGE
     index.php EST ACTIONNÉ. 
    ---------------------------------------------------------------
 --> 
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            <!-- ON CLICK, LE FICHIER DU MODULE (moduloScript.js) TRAITE LES INFOS -->
            <button type="button" id="btnAjouter" class="btn btn-success">
